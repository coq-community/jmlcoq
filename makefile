...
# coq_makefile -o makefile EqBoolAux.v FunctionHelpers.v JMLBasic2Minimal.v JMLBasic2MinimalImpl.v JMLDomain.v JMLExpressionNotations.v JMLFull2Basic.v JMLFull2BasicImpl.v JMLFullSyntax.v JMLFullSyntaxImpl.v JMLHelpers.v JMLNotations.v JMLNumeric.v JMLOpSem.v JMLProgram.v JMLProgramPlus.v JMLProgramPlusImpl.v JMLRac.v JMLRac2.v JMLRac3.v JMLRac_1_Correct.v JMLRac_2_Correct.v JMLRac_3_Correct.v JMLSemantics.v JMLSyntax.v ListAux.v ListFunctions.v ListHelpers.v ListType.v LogicHelpers.v OptionHelpers.v PosAux.v Prelude.v Stack.v TaggedList.v ZHelpers.v 
#
...
VFILES:= \
  ...
  Prelude.v\
  JMLProgramPlus.v\
  JMLProgramPlusImpl.v\
  JMLFull2Basic.v\
  JMLFull2BasicImpl.v\
  JMLBasic2Minimal.v\
  JMLBasic2MinimalImpl.v
VOFILES:=$(VFILES:.v=.vo)
